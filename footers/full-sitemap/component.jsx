// Full Sitemap — Four-column link grid with logo and social icons above copyright
...
export default function FullSitemap({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
