// List Digest — Compact numbered list of latest articles, no images, text-first
...
export default function ListDigest({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
