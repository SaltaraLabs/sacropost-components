// Minimal Strip — Single-line logo left, nav right, ultra-clean
...
export default function MinimalStrip({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
