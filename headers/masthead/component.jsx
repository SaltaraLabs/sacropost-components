// Masthead — Classic newspaper top bar with bold logo, date line and horizontal category nav
...
export default function Masthead({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
