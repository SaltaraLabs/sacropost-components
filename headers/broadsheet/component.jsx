// Broadsheet — Full-width date + edition bar above centred masthead logo
...
export default function Broadsheet({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
