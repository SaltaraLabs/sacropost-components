// Dark Top Bar — Dark nav with accent underlines and search icon
...
export default function DarkTopbar({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
