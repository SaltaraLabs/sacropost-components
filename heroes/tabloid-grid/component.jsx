// Tabloid Grid — Full-width lead image (60%) with stacked secondary stories alongside
...
export default function TabloidGrid({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
