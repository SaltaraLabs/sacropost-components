// Magazine Split — Two equal hero stories side by side with category kickers
...
export default function MagazineSplit({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
