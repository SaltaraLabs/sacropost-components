// Lead Full — Single dominant story: large image left, headline + summary right
...
export default function LeadFull({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
