// Breaking Banner — Full-bleed image with headline overlaid at bottom, ticker strip below
...
export default function BreakingBanner({ articles = [], siteName = 'SacroPost News' }) {
  return (
    <header
      style={{
    ...
    >
      {/* TODO: implement Breaking Banner */}
